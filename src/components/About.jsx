    ...
    id='About'>
        ...
        <div className='flex flex-col md:flex-row items-center md:items-start md:gap-20'>
            ...
            <div className='flex flex-col items-center md:items-start mt-10 text-gray-600'>
                ...
                <p className='my-10 max-w-lg'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed corrupti, obcaecati debitis et asperiores error soluta eveniet vero nesciunt repudiandae at earum expedita fugiat. Corporis temporibus repudiandae atque unde id.</p>
