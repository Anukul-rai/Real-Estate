...
function Header() {
  return (
    <div className='min-h-screen mb-4 bg-cover bg-center flex items-center w-full overflow-hidden' style={{backgroundImage:"url('/header.png')"    }}
    id='Header'>
      <Navbar/>
      <motion.div 
      ...
      className="container text-center mx-auto px-6 py-4 md:px-20 lg:px-32 text-white ">
        ...
        <div className="space-x-6 mt-16">
            <a href="#Projects" className="border boder-white px-8 py-3 rounded ">Projects</a>
